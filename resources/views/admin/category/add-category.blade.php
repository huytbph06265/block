                        ...
                        <div class="m-portlet m-portlet--tab">
                            ...
                            <div class="m-portlet__body">
                                <div class="form-group m-form__group">
                                    ...
                                    <input type="text" name="name" class="form-control m-input" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{old('name')}}" placeholder="nhập tiêu đề">
                                ...
                                <div class="form-group m-form__group">
                                    ...
                                    <textarea class="form-control m-input" name="description" id="exampleTextarea" rows="10">{{old('description')}}</textarea>
