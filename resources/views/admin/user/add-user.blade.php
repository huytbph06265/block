...
@section("content")
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-content">
            <form action="{{route('add-user-save')}}" enctype="multipart/form-data" method="post" class="m-form m-form--fit m-form--label-align-right">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <!--begin::Portlet-->
                        <div class="m-portlet m-portlet--tab">
                            ...
                            <div class="m-portlet__body">
                                <div class="form-group m-form__group">
                                    ...
                                    <input type="text" class="form-control m-input" name="name" id="exampleInputEmail1" aria-describedby="emailHelp" >
                                ...
                                <div class="form-group m-form__group">
                                    ...
                                    <input type="email" class="form-control m-input" name="email" id="exampleInputEmail1" aria-describedby="emailHelp" >
                                    @if($errors->first('name'))
                                        <span class="text-danger">{{$errors->first('name')}}</span>
                                    @endif
                                </div>
