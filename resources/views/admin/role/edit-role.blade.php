...
@section("content")
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        <div class="m-content">
            <form action="{{route('edit-role-save',['id' => $role->id])}}" method="post" class="m-form m-form--fit m-form--label-align-right" >
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <!--begin::Portlet-->
                        <div class="m-portlet m-portlet--tab">
                            ...
                            <div class="m-portlet__body">
                                <div class="form-group m-form__group">
                                    ...
                                    <input type="text" value="{{$role->name}}" class="form-control m-input" name="role" id="exampleInputEmail1" aria-describedby="emailHelp" >
                                </div>
                                <div class="form-group m-form__group">
